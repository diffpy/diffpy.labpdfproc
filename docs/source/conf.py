...
# -*- coding: utf-8 -*-
#
# diffpy.my-labpdfproc documentation build configuration file, created by  # noqa: E501
...
try:
    fullversion = version("diffpy.my_labpdfproc")
except Exception:
...
modindex_common_prefix = ["diffpy.my-labpdfproc"]
...
html_context = {
    "display_github": True,
    "github_user": "diffpy",
    "github_repo": "diffpy.my-labpdfproc",
    "github_version": "main",
...
basename = "diffpy.my-labpdfproc".replace(" ", "").replace(".", "")
...
latex_documents = [
    (
        "index",
        "diffpy.my-labpdfproc.tex",
        "diffpy.my-labpdfproc Documentation",
        ab_authors,
        "manual",
    ),
]
